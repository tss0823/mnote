...
/**
 * 字符串处理工具类
 * @Type StringHelper.java
 * @Desc
 * @author 于继伟
 * @date 2017年11月28日 下午9:46:08
 * @version
 */
public class StringUtil {
    ...
    public static String clearHtml(String html) {
        ...
        try {
            ...
            while (matcher.find()) {
                ...
                if (first) {
                    bf.append(html, 0, start);
                    first = false;
                } else {
                    bf.append(html, end, start);
                }
    ...
    public static String toLowerStr(String strIn) {
        StringBuilder strOut = new StringBuilder(); // 输出的字串
    ...
    public static String formatDate(String date) {
        ...
        dateBuf.append(date, 0, 4);
        dateBuf.append("-");
        dateBuf.append(date, 4, 6);
        dateBuf.append("-");
        dateBuf.append(date, 6, 8);
    ...
    /**
     * 描述：把某一个字符变成小写 时间：Dec 17, 2010 9:42:32 PM
     *
     * @param str
     *            str 字串
     * @param index
    ...
    /**
     * 描述：把某一个字符变成大写或小写 时间：Dec 17, 2010 9:39:32 PM
     *
     * @param str
     *            字串
     * @param index
    ...
    public static String toUpOrLowOneChar(String str, int index, int upOrLow) {
        if (StringUtil.isNotEmpty(str) && index > -1 && index < str.length()) {
