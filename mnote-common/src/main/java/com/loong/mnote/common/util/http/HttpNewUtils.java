...
public class HttpNewUtils {
    ...
    public static ResponseRes  get(String url){
        ...
        try{
            ...
            BizException bizException = new BizException("http execute failed!", ExceptionUtils.getStackTrace(e));
            if(e instanceof ConnectTimeoutException || e instanceof SocketTimeoutException){
                bizException.setCode(SystemConstant.ResponseCode.TIME_OUT);
            }
            throw bizException;
        }finally {
            if(response != null){
...
//        RequestRes requestRes = new RequestRes();
//        requestRes.setUrl("https://stage.meitudata.com/meitupu/2f91be21-c1ad-4eef-86ba-62656bf598e6.png?imageInfo");
//        ResponseRes responseRes = execute(requestRes);
//        log.info(responseRes.getStatus().toString());
...
//        }
        ...
        ResponseRes responseRes1 = get("https://stage.meitudata.com/meitupu/2f91be21-c1ad-4eef-86ba-62656bf598e6.png?imageInfo");
        String bodyText = responseRes1.getBodyText();
